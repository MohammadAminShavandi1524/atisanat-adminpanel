...
import { ArrowDownUp, Handshake, Search } from "lucide-react";
...
import CooperationRequestRow from "./CooperationRequestRow";
...
const CooperationRequestsPage = () => {
  ...
  useEffect(() => {
    const fetchRequests = async () => {
      try {
        ...
        console.error("GET COOPERATION REQUESTS ERROR:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  useGSAP(
    () => {
      ...
      timeline.fromTo(
        ".cooperation-requests-table-header",
        {
          opacity: 0,
          y: 10,
        },
  ...
  return (
    <div ref={pageRef} className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="3xl:px-8 3xl:py-6 flex min-h-0 flex-1 flex-col px-8 py-6 xl:px-5 xl:py-5 2xl:px-6">
        <section className="cooperation-requests-panel border-border bg-card flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border">
          {/* Toolbar */}
          <div className="border-border 3xl:gap-5 3xl:p-5 flex shrink-0 items-center justify-between gap-5 border-b p-5 xl:gap-3 xl:p-4 2xl:gap-4 2xl:p-4.5">
            {/* Search */}
            <div className="cooperation-requests-search 3xl:max-w-[520px] relative w-full max-w-[520px] xl:max-w-[400px] 2xl:max-w-[460px]">
              <Search
                strokeWidth={1.8}
            ...
            {/* Sort */}
            <div className="cooperation-requests-sort shrink-0">
              <CustomButton
                type="button"
                variant="outline"
                intent="secondary"
          ...
          <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
            {/* Table Header */}
            <div className="cooperation-requests-table-header border-border bg-card-secondary 3xl:ps-9 3xl:pe-11 shrink-0 border-b ps-9 pe-11 xl:ps-6 xl:pe-8 2xl:ps-7 2xl:pe-9">
              <div className="text-muted-foreground 3xl:h-13 3xl:grid-cols-[60px_1.25fr_1.1fr_1.45fr_1.1fr_130px_130px_100px] 3xl:gap-4 3xl:text-sm grid h-13 grid-cols-[60px_1.25fr_1.1fr_1.45fr_1.1fr_130px_130px_100px] items-center gap-4 text-sm font-semibold xl:h-11 xl:grid-cols-[46px_1.15fr_1fr_1.25fr_1fr_105px_105px_82px] xl:gap-2.5 xl:text-[12px] 2xl:h-12 2xl:grid-cols-[52px_1.2fr_1.05fr_1.35fr_1.05fr_115px_115px_90px] 2xl:gap-3 2xl:text-[13px]">
                <div>{t("table.id")}</div>
