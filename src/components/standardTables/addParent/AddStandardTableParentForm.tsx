...
import ChartCoverUploadField from "./ChartCoverUploadField";

import {
  createParentChartSchema,
  type ParentChartFormValues,
} from "./add-parent-chart.schema";

import { createParentChart, uploadChartCover } from "./add-parent-chart.api";

const AddStandardTableParentForm = () => {
  ...
  const onSubmit = async (data: ParentChartFormValues) => {
    try {
      setIsUploading(true);
      ...
      console.error("CREATE PARENT CHART ERROR:", error);
...
export default AddStandardTableParentForm;
